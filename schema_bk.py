...
class Query(graphene.ObjectType):
    ...
    user_point_records = MongoengineConnectionField(Point_records,reg=graphene.Int(),month=graphene.Int(),year=graphene.Int())
     #point_records = graphene.List(lambda: Point_records,reg=graphene.Int(),month=graphene.Int(),year=graphene.Int())
    def resolve_user_point_records(self,info,reg,month,year):
        q = Query_Mongo();
        return list(q.Get_Point_Records_by_registration_month_year(reg,month,year))
